...
class Config(BaseModel):
    ...
    # 卡密商店链接：BREAK 不足或卡密不存在时引导主人前往购买。
    maimaidx_store_url: str = 'https://store.awmc.team/item?id=91'
    ...
    # 媒体上传单独限流，始终给签到、错误提示等轻量文本保留发送槽位。
    qq_media_send_max_concurrency: int = 4
    ...
    awmc_xf_redirect_uri: str = 'https://genshin.wmc.pub/'
